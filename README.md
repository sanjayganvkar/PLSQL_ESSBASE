...
The SQL interface allows the Oracle PL/SQL based applications to directly extract data from Essbase with the presentation done in a relational
format, which can be subsequently used in the SQL Queries..
